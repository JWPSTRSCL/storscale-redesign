...
const tiers = [
  {
    ...
    monthlyPrice: 0,
    annualPrice: 0,
    subtitle: 'Market intelligence, no commitment',
    features: [
  ...
  },
  {
    ...
    monthlyPrice: 249,
    annualPrice: 199,
    subtitle: 'For operators ready to optimize revenue',
    features: [
      'Everything in Passive',
      'Dedicated specialist, 3 optimizations/mo',
  ...
  },
  {
    ...
    monthlyPrice: 449,
    annualPrice: 359,
    subtitle: 'Full revenue intelligence for serious operators',
    features: [
  ...
  },
  {
    ...
    monthlyPrice: 799,
    annualPrice: 639,
    subtitle: 'Enterprise-grade intelligence for portfolios',
    features: [
      'Everything in Scale',
